...
module.exports = function (grunt, options) {
  var Helper             = new HelperCons(grunt, options),
      ...
      colorsSourceFile   = "app/components/styles/colors/colors.json",
      colorsDestFile     = options.config.srcDir + '/components/styles/colors',

      typographySourceFile = "app/components/styles/typography/typography.json",
      typographyDestFile = options.config.srcDir + '/components/styles/typography',

      theoColorsAdapterPath = '.tmp/colors-theo.json',
      theoTypographyAdapterPath = '.tmp/typography-theo.json',
