    ...
    grunt.registerTask('pagesAssembler', function(environment) {
        ...
        _.each(locales, function(data, localeName) {
            ...
            _.each(pages, function(page) {
                ...
                // grunt.log.writeln('compiling styleguide...');
                // grunt.log.writeln('instanciations ... : ' + instanciations);
                // var styleguide = Helper.jadeRender(
                //   grunt.file.glob.sync(srcDir + '/pages/styleguide.jade')[0],
                //   dataOptions,
                //   instanciations);
                ...
                grunt.log.writeln('saving styleguide... to ' + targetDir + '/styleguide/index.html');
                // grunt.file.write(targetDir + '/styleguide/index.html', styleguide);
            });
        });
    });
};
