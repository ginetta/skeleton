...
module.exports = function (grunt, options) {
  var Helper        = new HelperCons(grunt, options),
      componentListTemplate         = "lib/toolset/grunt-tasks/assembler/styleguide-templates/component-list.jade",
      componentTemplate             = "lib/toolset/grunt-tasks/assembler/styleguide-templates/component.jade",
      componentCombinationTemplate  = "lib/toolset/grunt-tasks/assembler/styleguide-templates/component-combination.jade";
