module.exports = function(grunt, options) {
    ...
    grunt.registerTask('addComponent', function() {
        var componentName = grunt.option("name"),
            ...
            parentComponentFolder = componentsFolder + parentComponentName + "/";
        ...
        if (parentComponentName) {
            componentFolder = parentComponentFolder + componentName + '/';
            write(componentFolder + componentName + ".js", jsContent);
            write(componentFolder + componentName + ".scss", scssContent);
            write(componentFolder + componentName + ".jade", jadeContent);
            write(componentFolder + "package.yml", packageContent);

            // if parentComponents is already a prentComponent
            //  i.e.: it has the components.jade and components.scss file
            var parentComponentsScss = parentComponentFolder + "components.scss";
            var parentComponentsJade = parentComponentFolder + "components.jade";
            if (grunt.file.exists(parentComponentsScss) && grunt.file.exists(parentComponentsJade)) {
                replaceLine(
                  parentComponentsScss,
                  "  ;",
                ...
                write(parentComponentFolder + "components.scss", componentsScssContents);
                ...
                write(parentComponentFolder + "components.jade", componentsJadeContents);
